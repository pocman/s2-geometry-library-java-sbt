...
public strictfp class S2LatLngTest extends GeometryTestCase {
  ...
  public void testConversion() {
    ...
    for (int i = 14; i < 15; i += 2) {
      S2CellId cellIdParent = cellId.parent(i);
      S2Cell cellParent = new S2Cell(cellIdParent);
      S2LatLngRect rect = cellParent.getRectBound();
      System.out.println("[["+ rect.lo().lngDegrees() + ", " + rect.lo().latDegrees() + "], [" + rect.hi().lngDegrees() + ", " + rect.hi().latDegrees() + "]]");
    }
  }
